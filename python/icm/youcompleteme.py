...
from icm import base, paths, vimsupport
from ycmd import utils
from ycmd import server_utils
from ycmd.request_wrap import RequestWrap
from icm.diagnostic_interface import DiagnosticInterface
from icm.omni_completer import OmniCompleter
from icm import syntax_parse
from icm.client.ycmd_keepalive import YcmdKeepalive
from icm.client.base_request import ( BaseRequest, BuildRequestData,
                                      HandleServerException )
from icm.client.completer_available_request import SendCompleterAvailableRequest
from icm.client.command_request import SendCommandRequest
from icm.client.completion_request import ( CompletionRequest,
                                            ConvertCompletionDataToVimData )
from icm.client.debug_info_request import ( SendDebugInfoRequest,
                                            FormatDebugInfoResponse )
from icm.client.omni_completion_request import OmniCompletionRequest
from icm.client.event_notification import ( SendEventNotificationAsync,
                                            EventNotification )
from icm.client.shutdown_request import SendShutdownRequest
...
SERVER_SHUTDOWN_MESSAGE = (
  "The ycmd server SHUT DOWN (restart with ':IcmRestartServer')." )
...
class YouCompleteMe( object ):
  def __init__( self, user_options ):
    ...
    self._logger = logging.getLogger( 'icm' )
